...
class CustomGestureDetector {
    ...
    CustomGestureDetector(Context context, OnGestureListener listener) {
        ...
        RotateGestureDetector.OnRotateGestureListener onRotateGestureListener = new RotateGestureDetector.OnRotateGestureListener() {
            @Override
        ...
        mRotateGestureDetector = new RotateGestureDetector(context, onRotateGestureListener);
    }
    ...
    public boolean isRotating() {
        return mRotateGestureDetector.isRotating();
    }
